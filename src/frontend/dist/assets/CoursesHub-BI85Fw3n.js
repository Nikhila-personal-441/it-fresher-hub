import { h as useSearch, r as reactExports, u as useSubscription, a as useInternetIdentity, j as jsxRuntimeExports, m as motion, l as Lock, d as Button, f as Badge, B as BookOpen, e as Skeleton, L as Link, t as Check } from "./index-DrrDo776.js";
import { S as Search, I as Input } from "./input-8wKDhKF5.js";
...
function CoursesHub() {
  ...
  const completedModuleIds = new Set((progressData == null ? void 0 : progressData.completedModules) ?? []);
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-bold text-lg text-foreground mb-5", children: [
            "₹199",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-normal text-muted-foreground", children: "/ lifetime" })
          ] }),
