...
function getCategoryColor(category) {
  const colors = {
    ...
    machinelearning: "bg-secondary/20 text-secondary-foreground border-secondary/40",
...
function getDifficultyColor(difficulty) {
  const colors = {
    ...
    advanced: "bg-destructive/10 text-destructive px-2.5 py-1 rounded-full text-xs font-medium"
  };
